...
f = open("/Users/tdudding/Desktop/DataWarehouse/candy_fixed1.csv", 'r')
reader = csv.reader(f)
...
sql = """copy candy_survey from 's3://candybucket00000001/candy_fix.csv'
    access_key_id 'AKIA5VXSMAGSU4NNLDUU'
    secret_access_key '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'
    region 'us-east-1'
    ignoreheader 1
    null as 'NA'
    removequotes
